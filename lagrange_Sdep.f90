...
use param
use sim_param,only:u,v,w,L11t,L22t,L33t,Q11t,Q22t,Q33t

use sgsmodule,only:F_LM,F_MM,F_QN,F_NN,beta,Cs_opt2,opftime, &
                   Beta_avg,Betaclip_avg,Cs_Ssim,TnLMMM,TnQNNN
...
! SKS - commented because this resulted in fort.95 (sort of core
! getting dumped..probable reason is theres no file opened with 
! pointer '95' !
! if (mod(jt,100) == 0) then
